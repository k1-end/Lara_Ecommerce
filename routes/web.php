...
Route::middleware([App\Http\Middleware\OnlyAdmin::class])->group(function () {
    Route::get('/dashboard/products/new' , [ProductController::class , 'create'])->name('new_product');
    Route::post('/dashboard/products/new' , [ProductController::class , 'store']);
    Route::get('/dashboard/products' , [ProductController::class , 'dashboard_index']);
    Route::get('/dashboard/products/{product}' , [ProductController::class , 'show']);
    Route::get('/dashboard/products/edit/{product}' , [ProductController::class , 'edit']);
    Route::get('/dashboard/products/delete/{product}' , [ProductController::class , 'destroy'])->name('delete_product');
